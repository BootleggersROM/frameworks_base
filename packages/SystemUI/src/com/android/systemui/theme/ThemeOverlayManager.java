...
class ThemeOverlayManager {
    ...
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_STYLE_ANDROID = "android.theme.customization.style.android";
    @VisibleForTesting
    ...
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_ICON_QS =
    ...
    ThemeOverlayManager(OverlayManager overlayManager, Executor executor,
        ...
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_ICON_QS, SYSUI_PACKAGE);
    }
